...
class FeatureExtract(object):
    ...
    def __init__(self, data=None, over_sampling=False, class_format=None, set='train', labels=None):
        '''
    ...
    def change_data_format(self, data, class_format, set, labels):
        '''
    ...
    def __load_word_embedding(self):
        ...
        print(BASE_DIR)
        newpath = BASE_DIR + "\\data\\glove.6B.50d.txt"
        f_glove = open(newpath, "rb")
        glove_vectors = {}
