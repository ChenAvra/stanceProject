...
def test_getModelWithType():
    tokenizer = loadTokenizer(MODEL_NAME)
    model=getModelWithType(MODEL_TYPE,BINARY_CLASSIFICATION,MAX_LENGTH_ARTICLE,MAX_LENGTH_HEADLINE,TRAIN_EMBED,tokenizer,num_of_labels)
    is1=False
